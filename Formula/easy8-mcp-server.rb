class Easy8McpServer < Formula
  ...
  if OS.mac?
    if Hardware::CPU.arm?
      url "https://github.com/bighub-ai/easy8-mcp-releases/releases/download/v0.3.2/easy8-mcp-server-aarch64-apple-darwin.tar.xz"
      sha256 "e4f46c4eeefb5dc51a335cfd47d4e655ceb38f529fb9dd7659b67905ef8ba489"
    end
    if Hardware::CPU.intel?
      url "https://github.com/bighub-ai/easy8-mcp-releases/releases/download/v0.3.2/easy8-mcp-server-x86_64-apple-darwin.tar.xz"
      sha256 "df6dca0d1e4a3991e4ad33a87bd99ee48f6478923b2149c8b7b9b8f7512043d3"
    end
  end
  if OS.linux?
    if Hardware::CPU.arm?
      url "https://github.com/bighub-ai/easy8-mcp-releases/releases/download/v0.3.2/easy8-mcp-server-aarch64-unknown-linux-gnu.tar.xz"
      sha256 "b17069dad771e1a69bf7fc7d069e15ed0bcf2a4b4ff1b1db741cbbd251c86f86"
    end
    if Hardware::CPU.intel?
      url "https://github.com/bighub-ai/easy8-mcp-releases/releases/download/v0.3.2/easy8-mcp-server-x86_64-unknown-linux-gnu.tar.xz"
