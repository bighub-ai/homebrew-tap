class Easy8McpServer < Formula
  ...
  if OS.mac?
    if Hardware::CPU.arm?
      url "https://github.com/bighub-ai/easy8-mcp/releases/download/v0.2.3/easy8-mcp-server-aarch64-apple-darwin.tar.xz"
      sha256 "64b81ac5c5c7813612a9526c12c3cc9921e6a3e16bf187401b927a7183026339"
    end
    if Hardware::CPU.intel?
      url "https://github.com/bighub-ai/easy8-mcp/releases/download/v0.2.3/easy8-mcp-server-x86_64-apple-darwin.tar.xz"
      sha256 "c2ac675f44be29fe4377488bac942ad6da6c39b4733fdc05816dd1dd6c5e6759"
    end
  end
  if OS.linux?
    if Hardware::CPU.arm?
      url "https://github.com/bighub-ai/easy8-mcp/releases/download/v0.2.3/easy8-mcp-server-aarch64-unknown-linux-gnu.tar.xz"
      sha256 "4673750f226f8e5ee26fac6a1ba489fbf2f38cccdce76a9aae83c131604330cc"
    end
    if Hardware::CPU.intel?
      url "https://github.com/bighub-ai/easy8-mcp/releases/download/v0.2.3/easy8-mcp-server-x86_64-unknown-linux-gnu.tar.xz"
