class EasyprojectMcpServer < Formula
  ...
  if OS.mac?
    if Hardware::CPU.arm?
      url "https://github.com/bighub-ai/easy8-mcp-releases/releases/download/v0.1.6/easyproject-mcp-server-aarch64-apple-darwin.tar.xz"
...
    if Hardware::CPU.intel?
      url "https://github.com/bighub-ai/easy8-mcp-releases/releases/download/v0.1.6/easyproject-mcp-server-x86_64-apple-darwin.tar.xz"
      sha256 "3920e71183ff8eb5a2c7900f4829f6e98a39a3214029dfe9e016a5605c1f6a22"
    end
  end
  if OS.linux?
    if Hardware::CPU.arm?
      url "https://github.com/bighub-ai/easy8-mcp-releases/releases/download/v0.1.6/easyproject-mcp-server-aarch64-unknown-linux-gnu.tar.xz"
      sha256 "f8f039cab51efeb10b129d40e6f6ab888c967fe847fd5bf303e803ce046be149"
    end
    if Hardware::CPU.intel?
      url "https://github.com/bighub-ai/easy8-mcp-releases/releases/download/v0.1.6/easyproject-mcp-server-x86_64-unknown-linux-gnu.tar.xz"
