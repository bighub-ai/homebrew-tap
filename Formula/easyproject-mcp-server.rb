class EasyprojectMcpServer < Formula
  ...
  if OS.mac?
    if Hardware::CPU.arm?
      url "https://github.com/bighub-ai/easy8-mcp/releases/download/v0.2.0/easyproject-mcp-server-aarch64-apple-darwin.tar.xz"
      sha256 "5ac508952ba74653189511f9b378b0c30300df0512fe32b2468295728a22e0e9"
    end
    if Hardware::CPU.intel?
      url "https://github.com/bighub-ai/easy8-mcp/releases/download/v0.2.0/easyproject-mcp-server-x86_64-apple-darwin.tar.xz"
      sha256 "755e06cd48d5fd59c2fa79230bd16eccc11c8601b0af607af90965968f51fff3"
    end
  end
  if OS.linux?
    if Hardware::CPU.arm?
      url "https://github.com/bighub-ai/easy8-mcp/releases/download/v0.2.0/easyproject-mcp-server-aarch64-unknown-linux-gnu.tar.xz"
      sha256 "65de37e2dbd975d332731fc22c0c3337eb8a5a705fe49da33cdc6407cb73ec23"
    end
    if Hardware::CPU.intel?
      url "https://github.com/bighub-ai/easy8-mcp/releases/download/v0.2.0/easyproject-mcp-server-x86_64-unknown-linux-gnu.tar.xz"
